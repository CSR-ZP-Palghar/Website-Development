                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="wel_header">
                            <h2>Welcome To VIKRAMGARH TALUK</h2>
                            <p>Select the Gram-Panchayat from the drop-down below and click 'Get Grampanchayat Data' button to view Grampanchayat-wise Requirements</p><br>
                            <p style="color:olive; font-size:22px;">PAGE UNDER DEVELPOMENT</p>
                        </div>
                    </div>
	                </div><br><br>
<form name="frm" method="POST" action="vikramgarh.php">
    <center>
    <table id="customers">
        <tr>
            <td align="right">
